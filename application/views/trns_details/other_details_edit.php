...
echo "<td><input name = det[$i][title] required id = title value = $value[title]>";
...
echo "<td style=width:10%><input type = number size = 13 name = det[$i][gstrate] required step = 0.01 placeholder = 0.00 value = $value[gst_rate] readonly></td>";
