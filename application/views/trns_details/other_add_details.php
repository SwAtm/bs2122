...
if (isset($calling_proc) and 'edit' == $calling_proc):
	echo "<form method = POST action = ".site_url("trns_details/edit_other_add/").">";
else:
	echo "<form method = POST action = ".site_url("trns_details/other_add_details/").">";
endif;
...
<tr><td id = cb></td>
<td align = center colspan="4"><input type = submit name =  complete id = complete formnovalidate="formnovalidate" value = 'Bill Over'></td></tr>
<?php
